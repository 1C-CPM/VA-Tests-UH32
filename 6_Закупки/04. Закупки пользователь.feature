...
Сценарий: 04.09. [ЗАПРОС КОТИРОВОК] ПТУ по договору ДД1
	...
	* Проверяем правильность заполнения строки
		...
		Тогда таблица "Товары" стала равной:
			...
			| '19.03'    | '22%'   | '950,000'    | '570 000,00' | 'т'       | '10.01'      | '600,00' | '570 000,00' | '102 786,89' | 'РОССИЯ'               | 'Материал1'    |
...
Сценарий: 04.10. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ПТУ по договору ДД2
	...
	* Проверяем правильность заполнения строки
		...
		# Тогда таблица "Товары" стала равной:
			...
			# | 'Материал2'    | '19.03'    | '22%'   | '200,000'    | '240 000,00' | 'т'       | '10.01'      | '1 200,00' | '240 000,00' | '40 000,00' | ''                     |
			# | 'Материал3'    | '19.03'    | '22%'   | '100,000'    | '110 000,00' | 'т'       | '10.01'      | '1 100,00' | '110 000,00' | '18 333,33' | ''                     |
