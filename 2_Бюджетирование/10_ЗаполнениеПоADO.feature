...
Сценарий: 10.01 Создание информационных баз
	...
	И Я создаю внешнюю информационную базу "ВА - Импорт ADO (Excel)" тип "ВА - Импорт ADO (Excel)" каталог "$КаталогПроекта$\2_Бюджетирование\Макеты\10\ADO" тип хранилища 'Excel'
...
Сценарий: 10.05 Создание экземпляра отчета
	...
	* Делаем расчет
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		Дано табличный документ 'ПолеТабличногоДокументаМакет' равен макету "2_Бюджетирование\Макеты\10\ВА_ИмпортADO.mxl"
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "2_Бюджетирование\Макеты\10\ВА_ИмпортADO_Движения.mxl" по шаблону
...
Сценарий: 10.06 Грузим второй файл
	...
	* Выбирем файл
		...
		И в поле с именем 'ПутьКФайлу' я ввожу текст "$КаталогПроекта$\2_Бюджетирование\Макеты\10\ADO\ВА_ЗагрузкаADO2.xls"
		И я нажимаю на кнопку с именем 'ФормаВыбрать'

	* Сверяемя результат
		Тогда открылось окно '$ЗаголовокОкна$'
		Дано табличный документ 'ПолеТабличногоДокументаМакет' равен макету "2_Бюджетирование\Макеты\10\ВА_ИмпортADO2.mxl"
