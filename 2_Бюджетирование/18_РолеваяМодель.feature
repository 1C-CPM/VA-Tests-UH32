...
Структура сценария: 18.08 Создание экземпляров отчетов
	...
	Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_20.mxl'
	И Я ввожу значение '100' в ячейку 'R6C2'	
	Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_100.mxl'
...
Сценарий: 18.16 Проверка СТ для пользователя "Бюджетирование2"
	...
	* Проверяем сводную таблицу с правами на запись
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_СТ_100.mxl'
		...
		И Я закрываю окно "Управление версиями показателей *"
		Тогда открылось окно '$ЗаголовокОкна$'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_СТ_20.mxl'
	...
	* Проверяем сводную таблицу без прав
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_НетДоступа.mxl'	
...
Сценарий: 18.19 Проверка СТ для пользователя "Бюджетирование3"
	...
	* Проверяем сводную таблицу с правами на чтение
		...
		И я нажимаю на кнопку с именем 'ОбновитьДанныеТаблицы1'
		И я жду открытия формы '$ЗаголовокОкна$' в течение 20 секунд
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_СТ_Пустой.mxl'
		И Я ввожу значение '100' в ячейку 'R4C2'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '2_Бюджетирование\Макеты\18\ВА_ПроверкаНастроекДоступа_СТ_Пустой.mxl'
