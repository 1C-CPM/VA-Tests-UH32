...
Сценарий: 07.09 Создание экземпляра отчета - "ВА - Нечисловые показатели (приемник)"  
	...
	* Рассчитываем документ и сравниваем итоговый документ
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен макету "2_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Меркурий.mxl"
...
Сценарий: 07.10 Расчет с удалением показателей
	...
	* Рассчитываем документ и сравниваем итоговый документ
		И я нажимаю на кнопку с именем 'ФормаЗаполнитьПоУмолчанию'
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен макету "2_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера.mxl"					
	...
	* Проверяем движения
		И движения экземпляра отчета стали равны "2_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера_Движения.mxl"
...
Сценарий: 07.11 Создание экземпляра отчета - "ВА - Расчет в коде" 
	...
	* Записываем документ и сверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "2_Бюджетирование\Макеты\07\ВА_РасчетВКоде_Движения.mxl" по шаблону
...
Сценарий: 07.12 Создание экземпляра отчета - "ВА - Группировка по аналитикам"
	...
	* Проверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "2_Бюджетирование\Макеты\07\ВА_ГруппировкаПоАналитикам_Движения.mxl" по шаблону
