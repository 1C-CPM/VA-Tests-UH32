...
Сценарий: 17.06 Просмотр аналитических отчетов
	...
	И табличный документ 'Результат' равен макету "3_Бюджетирование\Макеты\18\ВА_АналитическийОтчет.mxl" по шаблону
...
Сценарий: 17.07 Просмотр аналитических панелей		
	...
	И табличный документ 'Код_100000000001_1_Окно' равен макету "3_Бюджетирование\Макеты\18\ВА_АналитическийОтчет.mxl" по шаблону
	И табличный документ 'Код_100000000002_2_Окно' равен макету "3_Бюджетирование\Макеты\18\ВА_АналитическийОтчет.mxl" по шаблону
