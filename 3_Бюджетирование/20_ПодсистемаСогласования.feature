...
Сценарий: 20.05 Создание шаблона процесса согласования
	...
	* Настраиваем схему процесса		
		...
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		Тогда открылось окно "Переход по условию 1 (Этап универсального процесса)"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Переход по условию 1 (Этап универсального процесса)" в течение 20 секунд
