			...
			* Заполняем источник получения, проверяем заполнение полей				
				...
				Если '$$ЭтоЕРПУХ$$' Тогда
					...
					Тогда таблица "ТаблицаСоответствия" стала равной:
						...
						| 'Аналитика 1: Статьи ДДС' | 'Поле источника'    | '[Аналитика статей бюджетов].[Статья бюджета] (СтатьиДвиженияДенежныхСредств)' | 'Статьи ДДС'    |																									
				Иначе
			...
			* Добавляем отборы
				...
				* Добавляем значения отбора
					...
					Если '$$ЭтоЕРПУХ$$' Тогда
						И в таблице 'ДеревоПараметровОтбораБД' я перехожу к строке:
							| 'Поле'                                                                |
							| '[Регистратор] (ОтражениеФактическихДанныхБюджетирования).[Сценарий]' |
					Иначе
						И в таблице 'ДеревоПараметровОтбораБД' я перехожу к строке:
							| 'Поле'                     |
					...
					Если '$$ЭтоЕРПУХ$$' Тогда
						И в таблице 'ДеревоПараметровОтбораБД' я перехожу к строке:
							| 'Поле'                                                                                |
							| '[Регистратор] (ОтражениеФактическихДанныхБюджетирования).[Контрагент] (Контрагенты)' |
					Иначе
						И в таблице 'ДеревоПараметровОтбораБД' я перехожу к строке:
							| 'Поле'                                     |
							| '[Регистратор].[Контрагент] (Контрагенты)' |
