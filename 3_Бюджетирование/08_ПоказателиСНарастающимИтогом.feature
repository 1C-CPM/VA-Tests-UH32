...
Сценарий: 08.05 Создание экземпляра отчета - "ВА - Нарастающий итог (приемник)" 
	...
	* Рассчитываем и сверяем документ
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен макету "3_Бюджетирование\Макеты\08\ВА_НарастающийИтог.mxl"
	...
	* Смотрим движения
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\08\ВА_НарастающийИтог_Движения.mxl" по шаблону
