...
Сценарий: 07.07 Создание экземпляра отчета - "ВА - Нечисловые показатели (источник)" 
	...
	* Сравниваем итоговый документ
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.01.2024'      | "Да"             | '000001'  | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '1 846 667' | '01.01.2024'      | "Нет"             | ''        |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.02.2024'      | "Да"             | '000002'  | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '2 186 667' | '01.02.2024'      | "Нет"             | ''        |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.03.2024'      | "Да"             | '000003'  | '198 000'         | ''                | "Нет"            | ''        | '198 000'      | ''                | "Нет"            | ''        | '192 000'   | '01.03.2024'      | "Нет"             | ''        |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.04.2024'      | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '1 090 000' | '02.01.2024'      | "Нет"             | ''        |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024'      | "Да"             | '000005'  | '1 375 000'       | ''                | "Нет"            | ''        | '1 375 000'    | ''                | "Нет"            | ''        | '1 116 667' | '01.05.2024'      | "Нет"             | ''        |
...
Сценарий: 07.08 Интерактивное удаление показателей
	...
	* Сверяем результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.01.2024'      | "Да"             | '000001'  | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '1 846 667' | '01.01.2024'      | "Нет"             | ''        |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.02.2024'      | "Да"             | '000002'  | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '2 186 667' | ''                | "Нет"             | ''        |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.03.2024'      | "Да"             | '000003'  | '198 000'         | ''                | "Нет"            | ''        | '198 000'      | ''                | "Нет"            | ''        | '192 000'   | ''                | "Нет"             | ''        |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.04.2024'      | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '1 090 000' | '02.01.2024'      | "Нет"             | ''        |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024'      | "Да"             | '000005'  | '1 375 000'       | ''                | "Нет"            | ''        | '1 375 000'    | ''                | "Нет"            | ''        | '1 116 667' | ''                | "Нет"             | ''        |
	...
	* Сверяем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Управление холдингом 8 "            | '0'              | ''                | "Нет"            | ' '       | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '2 145 000' | ''                | "Нет"             | ''        |
			| "1С:Корпорация "                        | '0'              | ''                | "Нет"            | ''        | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '2 255 000' | ''                | "Нет"            | ''        |
			| "1С:ERP. Управление холдингом "         | '1 950 000'      | ''                | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '1 090 000' | ''                | "Нет"             | ''        |
...
Сценарий: 07.11 Создание экземпляра отчета - "ВА - Расчет в коде" 
	...
	* Рассчитываем документ и сверяем результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.01.2024' | "Да"     | '000001'                                                           | '2 145 000'       | '02.05.2024' | "Да"     | '2000005'                                                           | '2 145 000'    | '02.05.2024' | "Да"     | '2000005'                                                        | '5 540 000'  | ''     | "Нет"    | ''       |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.02.2024' | "Да"     | '000002'                                                           | '2 255 000'       | ''           | "Нет"    | ''                                                                  | '2 255 000'    | ''           | "Нет"    | ''                                                               | '6 560 000'  | ''     | "Нет"    | ''       |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.03.2024' | "Да"     | '000003'                                                           | '198 000'         | ''           | "Нет"    | ''                                                                  | '198 000'      | ''           | "Нет"    | ''                                                               | '576 000'    | ''     | "Нет"    | ''       |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.04.2024' | "Да"     | '000004'                                                           | '660 000'         | '02.01.2024' | "Да"     | '2000001'                                                           | '660 000'      | '02.01.2024' | "Да"     | '2000001'                                                        | '3 270 000'  | ''     | "Нет"    | ''       |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024' | "Да"     | '000005'                                                           | '1 375 000'       | ''           | "Нет"    | ''                                                                  | '1 375 000'    | ''           | "Нет"    | ''                                                               | '3 350 000'  | ''     | "Нет"    | ''       |
			...
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.02.2024' | "Нет"    | '!!! 000001'                                                       | '4 290 000'       | '02.06.2024' | "Нет"    | '!!! 2000005'                                                       | '6 435 000'    | '02.06.2024' | "Нет"    | '!!! 2000005'                                                    | '11 975 000' | ''     | "Нет"    | ''       |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.03.2024' | "Нет"    | '!!! 000002'                                                       | '4 510 000'       | ''           | "Да"     | ''                                                                  | '6 765 000'    | ''           | "Нет"    | ''                                                               | '13 325 000' | ''     | "Нет"    | ''       |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.04.2024' | "Нет"    | '!!! 000003'                                                       | '396 000'         | ''           | "Нет"    | ''                                                                  | '594 000'      | ''           | "Нет"    | ''                                                               | '1 170 000'  | ''     | "Нет"    | ''       |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.05.2024' | "Нет"    | '!!! 000004'                                                       | '1 320 000'       | '02.02.2024' | "Нет"    | '!!! 2000001'                                                       | '1 980 000'    | '02.02.2024' | "Нет"    | '!!! 2000001'                                                    | '5 250 000'  | ''     | "Нет"    | ''       |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.06.2024' | "Нет"    | '!!! 000005'                                                       | '2 750 000'       | ''           | "Нет"    | ''                                                                  | '4 125 000'    | ''           | "Нет"    | ''                                                               | '7 475 000'  | ''     | "Нет"    | ''       |
