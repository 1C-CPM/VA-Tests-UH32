	...
	* Устанавливаем формулы расчета для группы
		...
		* БезИтога
			...
			* Должна сработать проверка деления на 0
				...
				И я нажимаю на кнопку с именем 'Button0'
			Тогда открылось окно "Конструктор отчета *"
			И в поле с именем 'ПолеТекстовогоДокументаПроцедура' я ввожу текст "?({ВАГруппировкаПоАналитикам.ТоварыБезИтога_БезИтога}=0,-1,{ВАГруппировкаПоАналитикам.ТоварыСумма_БезИтога} / ?({ВАГруппировкаПоАналитикам.ТоварыБезИтога_БезИтога}=0,-1,{ВАГруппировкаПоАналитикам.ТоварыСумма_БезИтога})) "
			И я нажимаю на кнопку с именем 'ЗаписатьИСвернуть'
			Когда открылось окно "Конструктор отчета"
			И Я закрываю окно "Конструктор отчета"							
...
Сценарий: 07.08 Интерактивное удаление показателей
	...
	* Удаляем строку из формы раскрытия
		...
		И в таблице 'РаскрытиеПоказателей' я перехожу к строке:
			...
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест" | '600 000'            | '01.05.2024'         | "Да"                 | '000005'             | '1 375 000'          | "Нет"                | '1 375 000'          | "Нет"                |
		И в таблице 'РаскрытиеПоказателей' я нажимаю на кнопку с именем 'РаскрытиеПоказателейУдалить'
		И я нажимаю на кнопку с именем 'ФормаКнопкаОК'
...
Сценарий: 07.09 Создание экземпляра отчета - "ВА - Нечисловые показатели (приемник)"  
	...
	* Рассчитываем документ и сравниваем итоговый документ
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен макету "3_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Меркурий.mxl"
...
Сценарий: 07.10 Расчет с удалением показателей
	...
	* Рассчитываем документ и сравниваем итоговый документ
		И я нажимаю на кнопку с именем 'ФормаЗаполнитьПоУмолчанию'
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен макету "3_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера.mxl"					
	...
	* Проверяем движения
		И движения экземпляра отчета стали равны "3_Бюджетирование\Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера_Движения.mxl"
...
Сценарий: 07.11 Создание экземпляра отчета - "ВА - Расчет в коде" 
	...
	* Записываем документ и сверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\07\ВА_РасчетВКоде_Движения.mxl" по шаблону
...
Сценарий: 07.12 Создание экземпляра отчета - "ВА - Группировка по аналитикам"
	...
	* Проверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\07\ВА_ГруппировкаПоАналитикам_Движения.mxl" по шаблону
