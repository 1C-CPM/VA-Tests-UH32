...
Сценарий: Я создаю поступление ДС по виду операции 'TheBusinessOfTransaction' по договору 'TheName'	
	...
	* Заполнить реквизиты
		...
		//И в таблице "РасшифровкаПлатежа" из выпадающего списка с именем "РасшифровкаПлатежаДоговорКонтрагента" я выбираю по строке '[TheName]'	
	...
	* Особенности заполнения 
		Если элемент формы с именем "ВидОперацииУХ" стал равен 'Получение займа от контрагента' тогда
			...
			И в таблице "РасшифровкаПлатежа" в поле с именем "РасшифровкаПлатежаСтатьяДвиженияДенежныхСредств" я ввожу значение выражения 'ВАСтатья'
		Если элемент формы с именем "ВидОперацииУХ" стал равен 'Получение кредита в банке' тогда
			И в таблице "РасшифровкаПлатежа" из выпадающего списка с именем "РасшифровкаПлатежаЭлементСтруктурыЗадолженностиУХ" я выбираю точное значение 'Основной долг'
			И в таблице "РасшифровкаПлатежа" в поле с именем "РасшифровкаПлатежаСтатьяДвиженияДенежныхСредств" я ввожу значение выражения 'ВАСтатья'
		Если элемент формы с именем "ВидОперацииУХ" стал равен 'Возврат займа контрагентом' тогда
			И в таблице "РасшифровкаПлатежа" из выпадающего списка с именем "РасшифровкаПлатежаЭлементСтруктурыЗадолженностиУХ" я выбираю точное значение 'Основной долг'
			И в таблице "РасшифровкаПлатежа" в поле с именем "РасшифровкаПлатежаСтатьяДвиженияДенежныхСредств" я ввожу значение выражения 'ВАСтатья'
		Если элемент формы с именем "ВидОперацииУХ" стал равен 'Прочие поступления от контрагентов' тогда
			И в таблице "РасшифровкаПлатежа" из выпадающего списка с именем "РасшифровкаПлатежаЭлементСтруктурыЗадолженностиУХ" я выбираю точное значение 'Основной долг'
			И в таблице "РасшифровкаПлатежа" в поле с именем "РасшифровкаПлатежаСтатьяДвиженияДенежныхСредств" я ввожу значение выражения 'ВАСтатья'
