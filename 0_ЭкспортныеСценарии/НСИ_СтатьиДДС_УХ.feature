...
Сценарий: Я для статьи ДДС с именем 'TheName' определяю хозяйственную операцию 'TheBusinessTransaction' в 1C:ERPУХ
	...
	* Находим и заполняем элемент
		И Я в списке "Статьи движения денежных средств" по полю "Наименование" ищу элемент '[TheName]' "По началу строки"
		И в таблице "Список" я выбираю текущую строку
		Когда открылось окно '[TheName] (Статья движения денежных средств)'
		И я нажимаю на гиперссылку с именем "РедактироватьСписокХозяйственныхОпераций"
		Тогда открылось окно 'Список хозяйственных операций'
		И в таблице "СписокХозяйственныхОпераций" я нажимаю на кнопку с именем 'СписокХозяйственныхОперацийДобавить'
		Тогда открылось окно 'Хозяйственные операции'
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'             |
			| '[TheBusinessTransaction]' |
		И я нажимаю на кнопку с именем 'ФормаВыбрать'
		Тогда открылось окно 'Список хозяйственных операций *'
		И я нажимаю на кнопку с именем 'СохранитьСписок'
