...
Сценарий: ВводНаОсновании элемента документа "Реализация (акты, накладные, УПД)" (РеализацияТоваровУслуг)
	...
	* Ищем ссылку на существующий элемент
	...
	Если 'ЗначениеЗаполнено($НавигационнаяСсылка$)' Тогда
		...
		* Введем на основании Документ ЗаявлениеОВвозеТоваровПолученное
			Когда открылось окно '$ЗаголовокФормы$'
			Если элемент формы с именем 'ФормаДокументЗаявлениеОВвозеТоваровПолученноеСоздатьНаОсновании' присутствует на форме Тогда
				И я нажимаю на кнопку с именем 'ФормаДокументЗаявлениеОВвозеТоваровПолученноеСоздатьНаОсновании'
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось ввести Документ ЗаявлениеОВвозеТоваровПолученное на основании документа РеализацияТоваровУслуг
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось ввести Документ ЗаявлениеОВвозеТоваровПолученное на основании документа РеализацияТоваровУслуг
				Тогда открылось окно '* (создание)'
				И Я закрываю окно '* (создание)'
