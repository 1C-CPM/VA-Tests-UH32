...
Сценарий: Открытие формы обработки "Результаты обновления приложения" (РезультатыОбновленияПрограммы)
...
Сценарий: Открытие формы обработки "Создание отсутствующих версий договоров" (СозданиеОтсутствующихВерсийСоглашенийДоговоров)
