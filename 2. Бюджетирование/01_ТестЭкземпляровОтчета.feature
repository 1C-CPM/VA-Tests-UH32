...
Сценарий: 01.10 Создание экземпляра отчета	
	...
	Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Пустой.mxl'
...
Сценарий: 01.12 Копирование экземпляра отчета
	...
	* Сверим результат	
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Меркурий.mxl'
...
Сценарий: 01.13 Проверяем форму создания документа ЭО
	...
	* Рассчитываем по "Консолидировать периметр (МСФО)"
		...
		И я нажимаю на кнопку с именем 'ФормаВыбрать'
		Когда открылось окно '$ЗаголовокОкна$'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Система_МСФО.mxl' по шаблону
	...
	* Сверяем результат
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Система_Пропорционально.mxl'
	...
	* Сохраняем экземпляр отчета
		...
		И Я ввожу значение '2000,00000' в ячейку 'R12C2'
		Когда открылось окно '$ЗаголовокОкна$'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Система_Пропорционально.mxl' по шаблону
...
Сценарий: 01.16 Отображение в дополнительной валюте
	...
	* Сравниваем с эталоном
		Тогда открылось окно '$ЗаголовокОкна$'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_USD'
		И Я закрываю окно '$ЗаголовокОкна$'
		Тогда открылось окно "1С:Предприятие"
		И я нажимаю на кнопку с именем 'Button1'
...
Сценарий: 01.20 Сравнение версий
	...
	* Сравним версии
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_СравнениеВерсий_Различные.mxl'
		И Я закрываю окно "ВА - Ручной ввод по всем аналитикам *"
...
Сценарий: 01.21 Сворачивание до версии
	...
	* Сравниваем с эталонным макетом
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_2.mxl'
...
Сценарий: 01.22 Изменение отчета при выводе в тысячах
	...
	* Сравниваем с эталоном
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_3.mxl'
...
Сценарий: 01.23 Тестируем экземпляр отчета с разными бланками
	...
	* Проверяем дополнительный бланк
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет1' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_3.mxl'
	...
	* Меняем параметры отображения в экземпляре отчета
		...
		И я нажимаю на кнопку с именем 'ФормаПрименитьИЗакрыть'
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_СводнаяТаблица1.mxl'
	...
	* Настраиваем свойства
		...
		* Сравниваем результат
			Когда открылось окно '$ЗаголовокОкна$'	
			Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_СводнаяТаблица2.mxl'	
...
Сценарий: 01.24 Переходим в режим отображения данных
	...
	* Проверяем содержимое
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_СводнаяТаблица1.mxl'
	...
	* Тестируем кнопки настроек
		...
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_СводнаяТаблица2.mxl'
...
Сценарий: 01.25 Тестируем кнопки пересчета показателей
	...
	* Сравниваем результат
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету '\\Макеты\01\ВА_ВидОтчетаСАналитиками_СводнаяТаблица3.mxl' по шаблону		
