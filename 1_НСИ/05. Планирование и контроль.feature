...
Сценарий: 01.10 Организационная структура
	...
	* Учетная политика на 2024
		И я нахожу организацию с именем 'ВА - ООО Тест'
		Если '$$ЭтоУХ$$' Тогда
			И В текущем окне я нажимаю кнопку командного интерфейса "Учетная политика"
			И я нажимаю на кнопку с именем 'Создать'
			Тогда открылось окно "Учетная политика"
			И из выпадающего списка с именем 'ПрименяетсяС' я выбираю по строке "Январь 2024"
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
			И я жду закрытия окна "Учетная политика *" в течение 20 секунд
			И Я закрываю окно "ВА - ООО Тест (Организационная единица)"						
...
Сценарий: 01.17 Условия оплаты
	Если '$$ЭтоУХ$$' Тогда 
		...
		И Я создаю условие оплаты аванс ''\'' и постоплата '1'\'100'
