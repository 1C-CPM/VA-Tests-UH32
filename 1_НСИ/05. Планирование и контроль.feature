...
Сценарий: 01.10 Организационная структура
	* Создаюм ЮЛ
		...
		И Я для организации 'ВА - ООО Тест' создаю банковский счет '047567567' '40701840145250000973' в валюте 'USD'
...
Сценарий: 01.12 Контрагенты
	...
	И Я для контрагента с именем 'ВА - Поставщик1' создаю банковский счет '044525148' '40701840000000000016' в валюте 'USD'
