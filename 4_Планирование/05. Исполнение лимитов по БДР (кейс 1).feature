...
//		И из выпадающего списка с именем "Организация" я выбираю по строке 'ВА - ООО Тест'
	...
	* Проверить движения
		...
		Тогда таблица "ОперацииБюджетов" стала равной по шаблону:
			...
			| '1' | '01.01.2024 0:00:00' | 'Бюджет доходов и расходов' | 'Резервирование планов и лимитов * от *' | ''          | 'ВА - ЦФО 1 (АХО)'                | 'ВА - Статья 1 (ВА - Автотранспорт;  - ;  - ;  - ;  - ;  - ) Расход' | ''                       | ''                       | ''                   | ''                    | 'Расход'        | 'RUB'    | 'RUB'                  | '300 000,00' | ''           | '300 000,00' | ''                | ''                     | ''                | ''                | 'Нет'                   | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
			| '2' | '01.01.2024 0:00:00' | 'Бюджет доходов и расходов' | 'Резервирование планов и лимитов * от *' | ''          | 'ВА - ЦФО 1 (АХО)'                | 'ВА - Статья 1 (ВА - Здания;  - ;  - ;  - ;  - ;  - ) Расход'        | ''                       | ''                       | ''                   | ''                    | 'Расход'        | 'RUB'    | 'RUB'                  | '600 000,00' | ''           | '600 000,00' | ''                | ''                     | ''                | ''                | 'Нет'                   | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
			| '3' | '01.01.2024 0:00:00' | 'Бюджет доходов и расходов' | 'Резервирование планов и лимитов * от *' | ''          | 'ВА - ЦФО 1 (АХО); ВА - Проект 1' | 'ВА - Статья 4 Расход'                                               | ''                       | ''                       | ''                   | ''                    | 'Расход'        | 'RUB'    | 'RUB'                  | '900 000,00' | ''           | '900 000,00' | ''                | ''                     | ''                | ''                | 'Нет'                   | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
...
Сценарий: 05.01.3 Отражаем фактические данные об расходе	 		 		  		 		 		 	 
	...
	* Ввести Поступление на основание счета
		...
		И я вывожу значение переменной "ДатаДок"
	...
	* Проверить автоматическое создание ОФД
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И Я проверяю создание ОФД "Приобретение товаров и услуг" с параметром 'Нет'
	...
	* Скорректировать аналитики ОФД
		...
		Если текущее окно "не равно" ожидаемому окну "Статьи доходов и расходов" Тогда
			И в таблице "Взаиморасчеты" я нажимаю кнопку выбора у реквизита с именем "ВзаиморасчетыСтатьяБюджета"
			Тогда открылось окно "Выбор типа данных"
			И Я в таблице "" по полю "" ищу значение "Статья доходов и расходов"
			И я нажимаю на кнопку 'ОК'
	...
	* Проверить движения ОФД	
		...
		Если '$$ЭтоУХ$$' Тогда
			Тогда таблица "ОперацииБюджетов" стала равной по шаблону:
				| 'N' | 'Период'                             | 'Вид бюджета'               | 'Объект планирования'                                                       | 'Состояние' | 'Аналитика структуры'             | 'Аналитика статей бюджетов'                                   | 'Аналитика номенклатуры' | 'Аналитика потребностей' | 'Аналитика поставки' | 'Аналитика партнеров'                          | 'Приход расход' | 'Валюта' | 'Валюта лимитирования' | 'Сумма'     | 'Количество' | 'Лимит'     | 'Сумма исполнено' | 'Количество исполнено' | 'Лимит исполнено' | 'Источник версии' | 'Курс планирования' | 'Кратность планирования' | 'Курс лимитирования' | 'Кратность лимитирования' | 'Корректировка документа' |
				| '1' | '$$ЖелательнаяДатаРасхода$$ 0:00:00' | 'Бюджет доходов и расходов' | 'Заявка на расход *; 3 000 RUB *; ВА - Поставщик1; Расчеты с контрагентами' | ''          | 'ВА - ЦФО 1 (АХО); ВА - ООО Тест' | 'ВА - Статья 1 (ВА - Здания;  - ;  - ;  - ;  - ;  - ) Расход' | ''                       | ''                       | ''                   | 'ВА - ООО Тест; ВА - Поставщик1; Без договора' | 'Расход'        | 'RUB'    | 'RUB'                  | '-3 000,00' | ''           | '-3 000,00' | '3 000,00'        | ''                     | '3 000,00'        | ''                | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
		
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			Тогда таблица "ОперацииБюджетов" стала равной по шаблону:
				| 'N' | 'Период'                             | 'Вид бюджета'               | 'Объект планирования'                                                      | 'Состояние' | 'Аналитика структуры'             | 'Аналитика статей бюджетов'                                   | 'Аналитика номенклатуры' | 'Аналитика потребностей' | 'Аналитика поставки' | 'Аналитика партнеров'                                      | 'Приход расход' | 'Валюта' | 'Валюта лимитирования' | 'Сумма'     | 'Количество' | 'Лимит'     | 'Сумма исполнено' | 'Количество исполнено' | 'Лимит исполнено' | 'Источник версии' | 'Курс планирования' | 'Кратность планирования' | 'Курс лимитирования' | 'Кратность лимитирования' | 'Корректировка документа' |
				| '1' | '$$ЖелательнаяДатаРасхода$$ 0:00:00' | 'Бюджет доходов и расходов' | 'Заявка на расход *; 3 000 RUB * ВА - Поставщик1; Расчеты с контрагентами' | ''          | 'ВА - ЦФО 1 (АХО); ВА - ООО Тест' | 'ВА - Статья 1 (ВА - Здания;  - ;  - ;  - ;  - ;  - ) Расход' | ''                       | ''                       | ''                   | 'ВА - ООО Тест; ВА - Поставщик1; 04.01.2 от ; 04.01.2 от ' | 'Расход'        | 'RUB'    | 'RUB'                  | '-3 000,00' | ''           | '-3 000,00' | '3 000,00'        | ''                     | '3 000,00'        | ''                | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
...
Сценарий: 05.03.2 Создаем Заявку на корректировку лимита
	...
	* Проверяем средства к обеспечению в Отчете по лимитам
		...
		И я нажимаю на кнопку с именем 'СформироватьОтчет'
        И в табличном документе 'ОтчетТабличныйДокумент' ячейка с адресом 'R30C4' равна '$КОбеспечению$'
