...
Сценарий: 05.01.1 Создаем Резервирование планов и лимитов по ЦФО 1 (АХО) на 1 квартал 2024 год
	...
	* Проверяем зарезервированные средства в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамРезервБДР" по шаблону
...
Сценарий: 05.01.2 Создаем Заявку на расход				
	...
	* Проверяем заявленные средства в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамЗнР" по шаблону
...
Сценарий: 05.01.3 Отражаем фактические данные об расходе	 		 		  		 		 		 	 
	...
	* Проверяем факт расхода в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамФактРасхода" по шаблону
...
Сценарий: 05.02.2 Создаем Заявку на корректировку резерва
	...
	* Проверяем средства к обеспечению в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамКОбеспечениюБДР" по шаблону				
...
Сценарий: 05.02.3 Создаем Корректировку лимитов по заявке
	...
	* Проверяем корректировку лимитов в Отчете по лимитам					
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамКорректировкаБДР" по шаблону
