...
Сценарий: 09.02 Создать валютную Заявку на оплату (валют взаиморасчетов и платежа USD) 			
	...
	* Создать документ Заявка на оплату
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И Для партнера 'ВАКонтрагент' контрагента 'ВАКонтрагент' я создаю договор с видом 'С поставщиком' номер '09.02' от '' организация 'ВАОрганизация' валюта 'USD' сумма '100000' соглашение '' в 1C:ERPУХ
	...
	* Заполнить аналитики учета и планирования
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			...
			И я перехожу к следующему реквизиту
			Если элемент "Аналитика1" доступен для редактирования Тогда							
				И в таблице "РасшифровкаПлатежа" я активизирую поле с именем "Аналитика1"
				И в таблице "РасшифровкаПлатежа" в поле с именем "Аналитика1" я ввожу значение выражения 'ВААналитика1'
				И я перехожу к следующему реквизиту
...
Сценарий: 09.03 Создать валютную Заявку на оплату (валют взаиморасчетов USD и платежа EUR) 			
	...
	* Создать документ Заявка на оплату
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И Для партнера 'ВАКонтрагент' контрагента 'ВАКонтрагент' я создаю договор с видом 'С поставщиком' номер '09.03' от '' организация 'ВАОрганизация' валюта 'USD' сумма '100000' соглашение '' в 1C:ERPУХ
...
Сценарий: 09.04 Создать валютную Заявку на оплату (валют взаиморасчетов USD и платежа RUB) 			
	...
	* Создать документ Заявка на оплату
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И Для партнера 'ВАКонтрагент' контрагента 'ВАКонтрагент' я создаю договор с видом 'С поставщиком' номер '09.04' от '' организация 'ВАОрганизация' валюта 'USD' сумма '100000' соглашение '' в 1C:ERPУХ
