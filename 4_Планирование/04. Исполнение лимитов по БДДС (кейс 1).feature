...
Сценарий: 04.01.1 Создаем Резервирование планов и лимитов по ЦФО 1 (АХО) на 1 квартал 2024 год
	...
	* Проверяем зарезервированные средства в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамРезерв" по шаблону
...
Сценарий: 04.01.2 Создаем Заявку на оплату (по договору без графика расчетов)				
	...
	* Проверить движения
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			...
			И область "R6C2:R8C28" табличного документа 'ОтчетТабличныйДокумент' равна по шаблону:
				...
				| '$$ЖелательнаяДатаПлатежа$$ 0:00:00' | 'Бюджет движения денежных средств' | 'Заявка на оплату *; ВА - Поставщик1; Оплата поставщику' | ''          | 'ВА - ЦФО 1 (АХО); ВА - ООО Тест' | 'ВА - Статья 1 (ВА - Здания;  - ;  - ;  - ;  - ;  - ) Расход' | ''                       | ''                       | ''                   | 'ВА - ООО Тест; ВА - Поставщик1; 04.01.2 от ; 04.01.2 от ' | 'Расход'        | 'RUB'    | 'RUB'                  | '3 000,00'  | ''           | '3 000,00'  | ''                | ''                     | ''                | '*'                | ''                | 'Нет'                   | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
				| '$$ЖелательнаяДатаПлатежа$$ 0:00:00' | 'Бюджет движения денежных средств' | 'Резервирование планов и лимитов *'                      | ''          | 'ВА - ЦФО 1 (АХО); ВА - ООО Тест' | 'ВА - Статья 1 (ВА - Здания;  - ;  - ;  - ;  - ;  - ) Расход' | ''                       | ''                       | ''                   | 'ВА - ООО Тест; ВА - Поставщик1; 04.01.2 от '              | 'Расход'        | 'RUB'    | 'RUB'                  | '-3 000,00' | ''           | '-3 000,00' | ''                | ''                     | ''                | '*'                | ''                | 'Нет'                   | '1,0000'            | '1'                      | '1,0000'             | '1'                       | ''                        |
	...
	* Проверяем заявленные средства в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамЗнО" по шаблону
...
Сценарий: 04.01.4 Отражаем фактические данные об оплате	 		 		  		 		 		 	 
	...
	* Проверяем факт оплаты в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамФакт" по шаблону
...
Сценарий: 04.02.2 Создаем Заявку на корректировку резерва
	...
	* Проверяем средства к обеспечению в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамКОбеспечению" по шаблону
...
Сценарий: 04.02.3 Создаем Корректировку лимитов по заявке
	...
	* Проверяем корректировку лимитов в Отчете по лимитам					
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамКорректировка" по шаблону
		И Я закрываю окно 'Отчет по лимитам (период в строках)'
		Тогда открылось окно '1С:Предприятие'
		И я нажимаю на кнопку 'Нет'
...
Сценарий: 04.03.2 Создаем Заявку на корректировку лимита
	...
	* Проверяем средства к обеспечению в Отчете по лимитам
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "5_Планирование\Examples\ОтчетПоЛимитамКОбеспечениюПроект" по шаблону
