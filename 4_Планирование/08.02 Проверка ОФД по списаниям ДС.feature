...
Структура сценария: 08.01 Списание с расчетного счета в рублях
	...
	* Создаем договор
		Если не существует элемент справочника "ДоговорыКонтрагентов" с "Номер" равным <ТекВидДоговора> с "Контрагент" равным 'ВАКонтрагент' с "Организация" равным 'ВАОрганизация' Тогда
